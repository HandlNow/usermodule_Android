...
fun AppCompatActivity.replaceFragmentWithoutStack(fragment: Fragment, frameId: Int, args: Bundle) {
    fragment.arguments = args
    supportFragmentManager.inTransaction {
...
fun AppCompatActivity.replaceFragmentWithoutStackWithoutBundle(fragment: Fragment, frameId: Int=R.id.container) {
    supportFragmentManager.inTransaction {
        replace(frameId, fragment)
    }
}
