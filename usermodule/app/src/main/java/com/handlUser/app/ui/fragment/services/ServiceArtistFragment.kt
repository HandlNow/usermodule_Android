...
import com.handlUser.app.databinding.FragmentServiceMakeupArtistBinding
import com.handlUser.app.databinding.FragmentServicePaintingBinding
...
class ServiceArtistFragment : BaseFragment(), ClickHandler, BaseAdapter.OnItemClickListener, BaseAdapter.OnPageEndListener {

    private var binding: FragmentServiceMakeupArtistBinding? = null
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        if (binding == null)
            binding = DataBindingUtil.inflate(
                    inflater, R.layout.fragment_service_makeup_artist, container, false)
        return binding!!.root
    }
    ...
    private fun initUI() {
        ...
        baseActivity!!.setToolbar(getString(R.string.make_artist))
        hitGetDataAPI()
    }
