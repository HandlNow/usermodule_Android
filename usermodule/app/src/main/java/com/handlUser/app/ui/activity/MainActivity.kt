...
import com.handlUser.app.databinding.ActivityMainBinding
import com.handlUser.app.model.DrawerData
import com.handlUser.app.ui.adapter.DrawerAdapter
...
import com.handlUser.app.ui.fragment.login.HelpFragment
import com.handlUser.app.ui.fragment.login.LegalFragment
...
class MainActivity : BaseActivity(), BaseActivity.PermCallback, AdapterView.OnItemClickListener {
    ...
    override fun onBackPressed() {
        ...
        when {
            ...
            fragment is HomeFragment -> backAction()
    ...
    private fun showDataDialog(stringArray: Array<String>, frag: Fragment) {
        ...
        builderSingle.setAdapter(arrayAdapter) { dialog, which ->
            ...
            when (which) {
                ...
                2 -> {
                    bundle.putInt("type", Const.ABOUT)
                    frag.arguments = bundle
                    binding!!.drawer.closeDrawers()
                    supportFragmentManager.beginTransaction()
                            .replace(R.id.container, frag)
            ...
            when (controller) {
                ...
                "availability" -> {
                    when (action) {
                        ...
                        "change-state", "booking","provider-edit-request" -> {
    ...
    fun showCancelDialog() {
        val mDialogView =
            LayoutInflater.from(this).inflate(R.layout.dialog_custom_cancel, null)
        val mBuilder = android.app.AlertDialog.Builder(this, R.style.transparentDialog)
            .setView(mDialogView)
