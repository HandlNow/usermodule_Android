...
data class ProviderData(
        ...
        var avalibility: ArrayList<Avalibility> = arrayListOf(),
        @SerializedName("city")
        val city: String = "",
        ...
        @SerializedName("availbility_id")
        val availbilityId: Int = 0,
        ...
        @SerializedName("is_available_provider")
        val isAvailableProvider: Boolean = false,
...
data class ProviderService(
        ...
        @SerializedName("providerFile")
        val providerFile: ArrayList<ProviderFile> = arrayListOf(),
        @SerializedName("type_id")
        val typeId: Int = 0
) : Parcelable
