...
import com.handlUser.app.databinding.FragmentServiceDisinfectionBinding
...
class ServiceDisinfectionFragment : BaseFragment(), ClickHandler, BaseAdapter.OnItemClickListener, BaseAdapter.OnPageEndListener {

    private var binding: FragmentServiceDisinfectionBinding? = null
    private var alertDialog: AlertDialog? = null
    private var data: SubCategory? = null
    private var list: ArrayList<ServiceData> = arrayListOf()
    private var isSingle = false
    private var pageCount = 0
    private var adapter: CarWashAdapter? = null

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        if (binding == null)
            binding = DataBindingUtil.inflate(
                    inflater, R.layout.fragment_service_disinfection, container, false)
        return binding!!.root
    }
    ...
    private fun initUI() {
        ...
        baseActivity!!.setToolbar(getString(R.string.disinfection))
        resetList()
        hitGetDataAPI()
    }
    ...
    override fun onItemClick(vararg itemData: Any) {
        when (itemData[0] as Int) {
            ...
            Const.THREE -> {
                ...
                list[0].parent[pos].isChecked = !list[0].parent[pos].isChecked
    ...
    private fun setAdapter() {
        if (adapter == null) {
            adapter = CarWashAdapter(baseActivity!!, list[0].parent)
