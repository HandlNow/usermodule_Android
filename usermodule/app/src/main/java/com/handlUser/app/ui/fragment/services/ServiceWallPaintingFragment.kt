...
class ServiceWallPaintingFragment : BaseFragment(), ClickHandler, BaseAdapter.OnItemClickListener, BaseAdapter.OnPageEndListener {

    private var alertDialog: AlertDialog? = null
    private var binding: FragmentServicePaintingBinding? = null
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        if (binding == null)
            binding = DataBindingUtil.inflate(
                    inflater, R.layout.fragment_service_painting, container, false)
        return binding!!.root
    }
    ...
    private fun initUI() {
        ...
        baseActivity!!.setToolbar(getString(R.string.wall_painting), ContextCompat.getColor(baseActivity!!, R.color.White))
        resetList()
        hitGetDataAPI()
    }
