...
import com.handlService.app.ui.snackBar.ActionClickListener
import com.handlService.app.ui.snackBar.Snackbar
import com.handlService.app.ui.snackBar.SnackbarManager
import com.handlService.app.ui.snackBar.SnackbarType
import com.handlService.app.utils.*
...
open class BaseActivity : AppCompatActivity(), SyncEventListener, View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        apiInstance = if (com.handlService.app.BuildConfig.DEBUG) {
        ...
        progressDialog()
        failureDailog = android.app.AlertDialog.Builder(this,R.style.animateDialog)
    ...
    private fun showNoNetworkDialog(status: String?) {
        ...
        SnackbarManager.create(
                Snackbar.with(this)
                        ...
                        .text(status!!).duration(com.handlService.app.ui.snackBar.Snackbar
                                .SnackbarDuration.LENGTH_INDEFINITE)
                        .actionLabel(getString(R.string.retry_caps))
                        .actionListener(object : ActionClickListener {
                            override fun onActionClicked(snackbar: com.handlService.app.ui.snackBar.Snackbar) {
    ...
    fun dayOfWeek(date: String): Int {
        return try {
            ...
            calendar.time = now!!
            day = calendar[Calendar.DAY_OF_WEEK] - 1
            day
        } catch (e: Exception) {
            handleException(e)
            return 0
    ...
    fun getTimeFromDataFromGMT(startTime: String): String {
        val time = changeDateFormatGmtToLocal(startTime, Const.DATE_FORMAT, Const.DATE_FORMAT)
