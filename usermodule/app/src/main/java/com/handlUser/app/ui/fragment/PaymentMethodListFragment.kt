...
import com.handlUser.app.ui.fragment.login.AddUserDetailFragment
...
class PaymentMethodListFragment : BaseFragment(), ClickHandler {
    ...
    private fun initUI() {
        binding!!.addressRV.layoutManager=LinearLayoutManager(baseActivity)
        list.clear()
        adapter = null
    ...
    private fun setUpRecyclerView() {
        ...
        val itemTouchHelper = ItemTouchHelper(object : SwipeHelper(binding!!.addressRV) {
        ...
        itemTouchHelper.attachToRecyclerView(binding!!.addressRV)
    }
