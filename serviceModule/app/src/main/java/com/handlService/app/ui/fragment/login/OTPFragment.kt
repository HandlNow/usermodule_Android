...
import com.handlService.app.databinding.FragmentOtpVerificationBinding
...
import com.handlService.app.ui.fragment.AddPaymentFragment
...
import com.handlService.app.utils.TimeUtils
            ...
            if (responseUrl.contains(Const.API_VERIFY_OTP)) {
                if (responseCode == Const.STATUS_OK) {
                    ...
                    if (jsonObjects.has("error")) {
                        ...
                        restFullClient!!.setLoginStatus(jsonObjects.getString("access-token"))
                        baseActivity!!.replaceFragmentWithoutStackWithoutBundle(AddPaymentFragment())
                    }
                }
