...
import com.handlService.app.databinding.AdapterChatBinding
...
import com.handlService.app.ui.fragment.ChatFragment
import com.handlService.app.utils.Const
import com.handlService.app.utils.ZoomImageDialog
...
class ChatAdapter(val baseActivity: BaseActivity, var messageList: ArrayList<ChatData>, val fragment: ChatFragment) : BaseAdapter() {
    ...
    fun showDialog(arrayList: java.util.ArrayList<String>, pos: Int) {
